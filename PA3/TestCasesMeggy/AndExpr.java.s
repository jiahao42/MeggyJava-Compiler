...
MJ_L23: 
	...
	pop r25
	cp r24, r25
	brne MJ_L25 # if the left expr is false

MJ_L24: # if left expr is true
	# &&: right operand
	# start equality check
	# Load constant int 1
	ldi r24,lo8(1)
...
MJ_L33: # then branch
	...
	jmp MJ_L35 # jump over the else branch
...
MJ_L53: 
	...
	pop r25
	cp r24, r25
	brne MJ_L55 # if the left expr is false

MJ_L54: # if left expr is true
	# &&: right operand
	# start equality check
	# Load constant int 6
	ldi r24,lo8(6)
