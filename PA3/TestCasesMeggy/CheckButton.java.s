...
#### if statement
	...
	# if button value is zero, push 0 else push 1
	tst    r24 # Test for Zero or Minus
	breq MJ_L26 # goto false branch
MJ_L25: # if true
	ldi r24, 1
	jmp MJ_L27
MJ_L26: # false branch, r24 is already 0, do nothing
MJ_L27: 
	push r24
	...
	# if button value is zero, push 0 else push 1
	tst    r24 # Test for Zero or Minus
	breq MJ_L29 # goto false branch
MJ_L28: # if true
	ldi r24, 1
	jmp MJ_L30
MJ_L29: # false branch, r24 is already 0, do nothing
MJ_L30: 
	push r24
...
MJ_L22: # then branch
	...
	jmp MJ_L24 # jump over the else branch
